...
public class AutenticacaoTestCase  {

    private GenericValidation genericValidation;
    private ConexaoBancoDados conexaoBancoDados;
    GenericService genericService = new GenericService();

  //  public AutenticacaoTestCase() {
   ...
   // }
    ...
    public void allureReport(TestInfo testInfo) {
        ...
        Allure.feature("Micro Serviço de Autenticação");
    }

    @Test
    @DisplayName("Micro Serviço de Autenticação = Validar Token Super Admin")
    ...
    @Test
    @DisplayName("Micro Serviço de Autenticação = Validar Token Admin CD")
    ...
    @Test
    @DisplayName("Micro Serviço de Autenticação = Validar Token Admin Abrigo")
    ...
    @Test
    @DisplayName("Micro Serviço de Autenticação = Validar Token Voluntário")
